...
/**
 * Created by ouyangyufeng on 2019/3/6.
 */
...
public class SymmetricEncoder {
    ...
    public static final String KEY = "YOVsw4qJudR0Jp";
    /*
     * 加密
     * 1.构造密钥生成器
    ...
    public static void main(String[] args) {
        Map map = new HashMap<>();
        map.put("vin","V123456789");
        map.put("vehUse","乘用车");
        String enc = AESEncode(KEY, map.toString());
        System.out.println("加密后的数据: "+enc);
        System.out.println(AESDncode(KEY,enc));
    }
